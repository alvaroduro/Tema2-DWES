...
try {
    ...
    echo '<div class="alert alert-success w-100">' . "Conectado a la Base de Datos de usuarios!!" . '<img class="mx-2" width="60" height="50" src="img/iconoCheck.png" alt="iconoCheck"></div>';
